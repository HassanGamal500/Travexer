    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
          <h3 class="content-header-title">{{trans('admin.add dolane image')}}</h3>
        </div>
          ...
          <div class="breadcrumbs-top float-md-right">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{trans('admin.add dolane image')}}</a>
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" action="{{route('store_dolane_image')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">

                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" name="dolane_image[]" class="custom-file-input" id="inputGroupFile01 validationTooltip5" required multiple>
