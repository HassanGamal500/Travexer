                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('admin.all orders') }}</h4>
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration datatable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    @if($orders[0]->book_type == 1)
                                                    <th>{{ trans('admin.guide name') }}</th>
                                                    @else
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @if($order->book_type == 1)
                                                    <td>{{$order->guide_name}}</td>
                                                    @else
                                                    <td>{{$order->trip_title}}</td>
                                                    @endif
                                                    <td>{{$order->date}}</td>
                                                    <td>{{$order->time}}</td>
                                                    <td>
                                                        <a href="{{url(route('order_detail', $order->id))}}" class="btn btn-glow btn-bg-gradient-x-orange-yellow" data-target="#warning">
                                                            {{ trans('admin.detail') }}
                                                        </a>
                                                    </td>
                                                </tr>
