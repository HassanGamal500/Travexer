    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">{{ trans('admin.guides') }}</h3>
                <br>
                <a href="{{url(route('add_guide'))}}" class="btn btn-glow btn-bg-gradient-x-blue-green col-12 col-md-5 mr-1 mb-1">{{ trans('admin.AddNew') }}</a>
            </div>
                ...
                <div class="breadcrumbs-top float-md-right">
                    <div class="breadcrumb-wrapper mr-1">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('admin.guides') }}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('admin.all guide') }}</h4>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{url(route('edit_guide', $user->id))}}">{{trans('admin.edit')}}</a>
                                                                <button class="dropdown-item alerts" data-url="{{asset('admin/delete_guide')}}/" data-table="datatable" data-id="{{ $user->id }}">{{trans('admin.delete')}}</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
