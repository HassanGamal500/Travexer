    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
          <h3 class="content-header-title">{{trans('admin.edit advertisement')}}</h3>
        </div>
                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" action="{{route('update_advertisement', $banners->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">

                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" name="banner_image" class="custom-file-input" id="inputGroupFile01 validationTooltip5">
                                            ...
                                            <br>
                                            <input type="hidden" name="old_banner_image" value="{{ $banners->image }}">
                                            <img src="{{asset($banners->image)}}" class="img-thumbnail" height="70px" width="100px">
                                        </div>
