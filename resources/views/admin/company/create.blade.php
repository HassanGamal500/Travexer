    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
          <h3 class="content-header-title">{{trans('admin.add company')}}</h3>
        </div>
                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" action="{{route('store_company')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" id="validationTooltip10" class="form-control round" placeholder="{{trans('admin.enter location')}}" value="{{ old('location') }}" required>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" name="commerce_image" class="custom-file-input" id="inputGroupFile01 validationTooltip11" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  name="contact_name" id="validationTooltip12" class="form-control round" placeholder="{{trans('admin.enter contact name')}}" value="{{ old('contact_name') }}" required>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="tel" pattern="^[0-9]*$" name="contact_phone" id="validationTooltip13" class="form-control round" placeholder="{{trans('admin.enter contact phone')}}" value="{{ old('contact_phone') }}" required>
                                            <div class="invalid-tooltip">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="contact_email" id="validationTooltip14" class="form-control round" placeholder="{{trans('admin.enter contact email')}}" value="{{ old('contact_email') }}" required>
                                            <div class="invalid-tooltip">
