    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-4 col-12 mb-2">
          <h3 class="content-header-title">{{trans('admin.edit company')}}</h3>
        </div>
        <div class="content-header-right col-md-8 col-12">
          <div class="breadcrumbs-top float-md-right">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{asset('/admin/companies')}}">{{ trans('admin.companies') }}</a>
                </li>
                <li class="breadcrumb-item active">{{trans('admin.add company')}}</a>
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate method="post" action="{{route('update_company', $users->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label for="validationTooltip10">{{trans('admin.location')}}</label>
                                            <input type="text" name="location" id="validationTooltip10" class="form-control round" placeholder="{{trans('admin.enter location')}}" value="{{ $users->company_location }}" required>
                                            <div class="invalid-tooltip">
                                                {{ trans('admin.Please Enter Location.') }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" name="commerce_image" class="custom-file-input" id="inputGroupFile01 validationTooltip11">
                                                <label class="custom-file-label" for="inputGroupFile01 validationTooltip11">{{trans('admin.upload commercial registration')}}</label>
                                            </div>
                                            <br>
                                            <input type="hidden" name="old_commerce_image" value="{{$users->commercial_registration_no_image}}">
                                            <img src="{{asset($users->commercial_registration_no_image)}}" class="img-thumbnail" height="70px" width="100px">
                                            <div class="invalid-tooltip">
                                                {{ trans('admin.Please Upload Your Commercial Registration.') }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="validationTooltip12">{{trans('admin.Contact Name')}}</label>
                                            <input type="text"  name="contact_name" id="validationTooltip12" class="form-control round" placeholder="{{trans('admin.enter contact name')}}" value="{{ $users->contact_name }}" required>
                                            <div class="invalid-tooltip">
                                                {{ trans('admin.Please Enter Your Contact Name.') }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="validationTooltip13">{{trans('admin.Contact Phone')}}</label>
                                            <input type="tel" pattern="^[0-9]*$" name="contact_phone" id="validationTooltip13" class="form-control round" placeholder="{{trans('admin.enter contact phone')}}" value="{{ $users->contact_phone }}" required>
                                            <div class="invalid-tooltip">
                                                {{ trans('admin.Please Enter Your Contact Phone Number.') }}
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="validationTooltip14">{{trans('admin.Contact Email')}}</label>
                                            <input type="email" name="contact_email" id="validationTooltip14" class="form-control round" placeholder="{{trans('admin.enter contact email')}}" value="{{ $users->contact_email }}" required>
                                            <div class="invalid-tooltip">
                                                {{ trans('admin.Please Enter Your Contact Email Address.') }}
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <a href="{{asset('/admin/companies')}}" class="btn btn-danger mr-1">
